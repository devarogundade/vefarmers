...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface LendingPoolLogicInterface extends Interface {
  ...
  export interface LendingPoolLogic extends BaseContract {
    
    connect(runner?: ContractRunner | null): LendingPoolLogic;
    waitForDeployment(): Promise<this>;

    interface: LendingPoolLogicInterface;
