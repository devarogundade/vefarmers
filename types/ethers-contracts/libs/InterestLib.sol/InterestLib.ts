...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface InterestLibInterface extends Interface {
  ...
  export interface InterestLib extends BaseContract {
    
    connect(runner?: ContractRunner | null): InterestLib;
    waitForDeployment(): Promise<this>;

    interface: InterestLibInterface;
